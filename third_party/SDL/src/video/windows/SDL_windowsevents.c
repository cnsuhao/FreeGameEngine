...
SDL_RegisterApp(char *name, Uint32 style, void *hInst)
{
...
#endif
        SDL_Instance = (HINSTANCE)( hInst ? hInst : GetModuleHandle(NULL) );
    }
    ...
    cls.hCursor = NULL;
    cls.hIcon = LoadIcon(SDL_Instance, MAKEINTRESOURCE(SDL_ICON_RESOURCE));
    cls.hIconSm = cls.hIcon;
    cls.lpszMenuName = NULL;
    cls.lpszClassName = SDL_Appname;
    cls.hbrBackground = NULL;
    cls.hInstance = SDL_Instance;
    cls.style = SDL_Appstyle;
    cls.lpfnWndProc = WIN_WindowProc;
    cls.cbWndExtra = 0;
    cls.cbClsExtra = 0;
...
SDL_UnregisterApp()
{
    ...
    if (app_registered == 0) {
        ...
        if (GetClassInfoEx(SDL_Instance, SDL_Appname, &cls)) {
