...
/*  modify by zhoubao.
    on WIN32, this function will cause link error, so disable it.
    MSVCRTD.lib(ftol2.obj) : error LNK2005: __ftol2_sse already defined in SDL.lib(SDL_stdlib.obj)
*/
#if 0 
void
_ftol2_sse()
