...
namespace LPCD
{
    ...
    inline void Push(lua_State* L, long long value)			{  lua_pushnumber(L, (lua_Number)value);  }
	inline void Push(lua_State* L, unsigned long long value){  lua_pushnumber(L, (lua_Number)value);  }
...
namespace LPCD
{
	...
	public:
		static int PropertyGet(lua_State* L)
		{
			...
			LPCD::Push(L, *(VarType*)((unsigned char*)obj + (size_t)offset));
		...
		static int PropertySet(lua_State* L)
		{
			...
			*(VarType*)((unsigned char*)obj + (size_t)offset) = Get(TypeWrapper<VarType>(), L, 2);
