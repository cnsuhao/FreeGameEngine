...
def main():
	...
	cxx_generator_root = os.path.abspath(os.path.join(project_root, 'tool/bindings-generator'))
	class_root = os.path.join(project_root, "src")
	...
	try:
		...
		tolua_root = '%s/tool/gen-bindings' % project_root
		output_dir = '%s/src/script/auto' % project_root

		cmd_args = {'freegame.ini' : ('freegame', 'lua_freegame_auto'),
					}
		target = 'lua'
